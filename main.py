...
from services.git import GitManager, GitError
...
class FixitAgentError(Exception):
    """Base exception for Fixit Agent errors"""
    pass
...
class FixitAgent:
    ...
    def _checkout_branch(self, branch_name: str) -> None:
        ...
        try:
            ...
            raise FixitAgentError("Failed to create and checkout branch") from e
    ...
    def _execute_instructions(self, coder: AiderClient, instructions: str) -> str:
        ...
        try:
            ...
            raise FixitAgentError("Failed to execute instructions") from e
